...
namespace Goss
{
	...
	VulkanDevice::~VulkanDevice()
	{
		...
		vkDestroySurfaceKHR(instance, vkSurfaceKHR, nullptr);
	...
	SwapChainSupportDetails VulkanDevice::QuerySwapChainSupport(const VkPhysicalDevice device) const
	{
		...
		vkGetPhysicalDeviceSurfaceFormatsKHR(device, vkSurfaceKHR, &formatCount, nullptr);

		if (formatCount != 0)
		{
			details.formats.resize(formatCount);
			vkGetPhysicalDeviceSurfaceFormatsKHR(device, vkSurfaceKHR, &formatCount, details.formats.data());
		}
		...
		if (presentModeCount != 0)
		{
			...
			vkGetPhysicalDeviceSurfacePresentModesKHR(device, vkSurfaceKHR, &presentModeCount,details.presentModes.data());
		}
		return details;
	}
